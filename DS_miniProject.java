...
Route: ASHRAM -> VINOBAPURI -> LAJPAT NAGAR -> JANGPURA -> JLN STADIUM -> KHAN MARKET -> CENTRAL SECRETARIAT -> JANPATH -> End
...
Alternative Route 1: ASHRAM -> NIZAMUDDIN -> MAYUR VIHAR -> AKSHARDHAM -> YAMUNA BANK -> INDRAPRASTHA -> SUPREME COURT -> MANDI HOUSE -> RAJIV CHOWK -> PATEL CHOWK -> CENTRAL SECRETARIAT -> JANPATH -> End
Price :2018.0
Alternative Route 2: ASHRAM -> NIZAMUDDIN -> MAYUR VIHAR -> AKSHARDHAM -> YAMUNA BANK -> INDRAPRASTHA -> SUPREME COURT -> MANDI HOUSE -> JANPATH -> End
Price :2013.5
Alternative Route 3: ASHRAM -> VINOBAPURI -> LAJPAT NAGAR -> SOUTH EXTENTION -> DILLI HAAT -> JOR BAGH -> LOK KALYAN MARG -> UDYOG BHAWAN -> CENTRAL SECRETARIAT -> PATEL CHOWK -> RAJIV CHOWK -> MANDI HOUSE -> JANPATH -> End
Price :2019.5
Alternative Route 4: ASHRAM -> VINOBAPURI -> LAJPAT NAGAR -> SOUTH EXTENTION -> DILLI HAAT -> JOR BAGH -> LOK KALYAN MARG -> UDYOG BHAWAN -> CENTRAL SECRETARIAT -> JANPATH -> End
Price :2015.0
Alternative Route 5: ASHRAM -> VINOBAPURI -> LAJPAT NAGAR -> JANGPURA -> JLN STADIUM -> KHAN MARKET -> CENTRAL SECRETARIAT -> PATEL CHOWK -> RAJIV CHOWK -> MANDI HOUSE -> JANPATH -> End
Price :2016.5
Alternative Route 6: ASHRAM -> VINOBAPURI -> LAJPAT NAGAR -> JANGPURA -> JLN STADIUM -> KHAN MARKET -> CENTRAL SECRETARIAT -> JANPATH -> End
Price :2012.0
...
Minimal Transfer Path: ASHRAM -> VINOBAPURI -> LAJPAT NAGAR -> JANGPURA -> JLN STADIUM -> KHAN MARKET -> CENTRAL SECRETARIAT -> JANPATH -> End
Price: 2012.0
Passenger: Namrata Hirani
Phone Number: 9938227162
Bill Amount: 28.8
...
dilli haat
Station DILLI HAAT does not lie on your path
...
Midway station is not on the path from start to destination.
Minimal Transfer Path: JANGPURA -> LAJPAT NAGAR -> SOUTH EXTENTION -> DILLI HAAT -> End
Price: 206.0
Passenger: Namrata Hirani
Phone Number: 9938227162
Bill Amount: 23.400000000000002
